...
function Calendar({
	...
	return (
		<DayPicker
			...
			className={cn(
				"bg-background group/calendar p-3 [--cell-size:2rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent dark:bg-slate-950",
			...
			classNames={{
				...
				today: cn(
					"bg-primary text-foreground rounded-md data-[selected=true]:rounded-none dark:bg-primary dark:text-slate-50",
